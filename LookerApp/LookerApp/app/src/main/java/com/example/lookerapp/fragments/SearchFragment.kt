...
import com.example.lookerapp.adapters.SearchAdapter
import com.example.lookerapp.databinding.FragmentSearchBinding
...
class SearchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.searchButton.setOnClickListener {
            ...
            Firebase.firestore.collection("User").whereEqualTo("name",text).get().addOnSuccessListener {
