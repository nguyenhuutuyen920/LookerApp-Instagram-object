package com.example.lookerapp.adapters
...
import com.example.lookerapp.databinding.PostRvBinding
...
class PostAdapter(var context: Context,var postList: ArrayList<Post>):RecyclerView.Adapter<PostAdapter.MyHolder>() {
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        try {
            Firebase.firestore.collection("User").document(postList.get(position).uid).get().addOnSuccessListener {
